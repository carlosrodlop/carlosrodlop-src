...
docker-run-base-local: ## Build and Run locally the docker base configuration. Usage: make docker-run-base-local
docker-run-base-local: 
	...
	@docker run --name base_tools -it --rm \
        ...
        localbuild.carlosrodlop-src.base:latest
